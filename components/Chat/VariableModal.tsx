...
export const VariableModal: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    // Set a timeout to delay the addition of the event listener
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="dark:border-netural-400 inline-block max-h-[400px] transform overflow-y-auto rounded-lg border border-gray-300 bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all dark:bg-[#202123] sm:my-8 sm:max-h-[600px] md:max-h-[670px] sm:w-full sm:max-w-lg sm:p-6 sm:align-middle"
        role="dialog"
      >
        ...
        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            <div className="mb-2 text-sm font-bold text-neutral-800 dark:text-neutral-200">
              {variable.key}
            </div>
